...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,company,const DeepCollectionEquality().hash(titles),sc,so,rank,remarks,const DeepCollectionEquality().hash(tags),createdAt,updatedAt,version);

@override
String toString() {
  return 'PositionModel(id: $id, company: $company, titles: $titles, sc: $sc, so: $so, rank: $rank, remarks: $remarks, tags: $tags, createdAt: $createdAt, updatedAt: $updatedAt, version: $version)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,company,const DeepCollectionEquality().hash(_titles),sc,so,rank,remarks,const DeepCollectionEquality().hash(_tags),createdAt,updatedAt,version);
