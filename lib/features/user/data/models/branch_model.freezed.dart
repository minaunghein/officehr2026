...
@JsonKey(name: '_id') String get id; String get company;@JsonKey(name: 'sc') String get shortCode; String get name;@JsonKey(name: 'activebranch') bool get active; double get lat; double get long; bool get deleted; List<String> get tags; DateTime? get deletedAt; int? get branchid;@JsonKey(name: '__v') int? get version;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,company,shortCode,name,active,lat,long,deleted,const DeepCollectionEquality().hash(tags),deletedAt,branchid,version);

@override
String toString() {
  return 'BranchModel(id: $id, company: $company, shortCode: $shortCode, name: $name, active: $active, lat: $lat, long: $long, deleted: $deleted, tags: $tags, deletedAt: $deletedAt, branchid: $branchid, version: $version)';
}
...
@useResult
$Res call({
@JsonKey(name: '_id') String id, String company,@JsonKey(name: 'sc') String shortCode, String name,@JsonKey(name: 'activebranch') bool active, double lat, double long, bool deleted, List<String> tags, DateTime? deletedAt, int? branchid,@JsonKey(name: '__v') int? version
});
...
/// Create a copy of BranchModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? company = null,Object? shortCode = null,Object? name = null,Object? active = null,Object? lat = null,Object? long = null,Object? deleted = null,Object? tags = null,Object? deletedAt = freezed,Object? branchid = freezed,Object? version = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String company, @JsonKey(name: 'sc')  String shortCode,  String name, @JsonKey(name: 'activebranch')  bool active,  double lat,  double long,  bool deleted,  List<String> tags,  DateTime? deletedAt,  int? branchid, @JsonKey(name: '__v')  int? version)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BranchModel() when $default != null:
return $default(_that.id,_that.company,_that.shortCode,_that.name,_that.active,_that.lat,_that.long,_that.deleted,_that.tags,_that.deletedAt,_that.branchid,_that.version);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: '_id')  String id,  String company, @JsonKey(name: 'sc')  String shortCode,  String name, @JsonKey(name: 'activebranch')  bool active,  double lat,  double long,  bool deleted,  List<String> tags,  DateTime? deletedAt,  int? branchid, @JsonKey(name: '__v')  int? version)  $default,) {final _that = this;
switch (_that) {
case _BranchModel():
return $default(_that.id,_that.company,_that.shortCode,_that.name,_that.active,_that.lat,_that.long,_that.deleted,_that.tags,_that.deletedAt,_that.branchid,_that.version);case _:
  throw StateError('Unexpected subclass');
...
class _BranchModel implements BranchModel {
  const _BranchModel({@JsonKey(name: '_id') required this.id, required this.company, @JsonKey(name: 'sc') required this.shortCode, required this.name, @JsonKey(name: 'activebranch') this.active = true, this.lat = 0.0, this.long = 0.0, this.deleted = false, final  List<String> tags = const [], this.deletedAt, this.branchid, @JsonKey(name: '__v') this.version}): _tags = tags;
...
@override@JsonKey(name: 'activebranch') final  bool active;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,company,shortCode,name,active,lat,long,deleted,const DeepCollectionEquality().hash(_tags),deletedAt,branchid,version);
...
/// Create a copy of BranchModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? company = null,Object? shortCode = null,Object? name = null,Object? active = null,Object? lat = null,Object? long = null,Object? deleted = null,Object? tags = null,Object? deletedAt = freezed,Object? branchid = freezed,Object? version = freezed,}) {
